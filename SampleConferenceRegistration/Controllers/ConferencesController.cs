...
namespace SampleConferenceRegistration.Controllers
{
    public class ConferencesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ConferenceId,Name,Location,StartDate,EndDate,Coordinator")] Conference conference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ConferenceId,Name,Location,StartDate,EndDate,Coordinator")] Conference conference)
        {
            if (ModelState.IsValid)
            {
